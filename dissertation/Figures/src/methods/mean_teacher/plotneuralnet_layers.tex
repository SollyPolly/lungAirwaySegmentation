%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Vendored drawing primitives from PlotNeuralNet.
%
%   Source : https://github.com/HarisIqbal88/PlotNeuralNet
%   Files  : layers/Box.sty, layers/RightBandedBox.sty, layers/init.tex
%   Licence: MIT, Copyright (c) 2018 HarisIqbal88
%
% Reproduced verbatim apart from three mechanical changes so the definitions can be
% \input by a standalone figure instead of \usepackage'd:
%   * the \ProvidesPackage lines are removed;
%   * the \usepackage{Ball}/{Box}/{RightBandedBox} lines of init.tex are removed;
%   * the required tikz libraries are loaded here.
% No geometry, colour, anchor or label logic has been altered.  The MIT licence
% permits this use; the attribution above is the licence's only condition.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Box -- a plain block of one or more boxes in a single fill colour.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% RightBandedBox -- as Box, but each box carries a right-hand band in a second
% colour.  This is the conv/activation pair grammar of the PlotNeuralNet examples.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
